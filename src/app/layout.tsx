      ...
      <body className="antialiased" suppressHydrationWarning>
        <AuthProvider>
          <ToastProvider>
            ...
            <header className="relative sticky top-0 z-40 border-b border-neutral-200/70 bg-white/95 shadow-sm backdrop-blur-xl">
              ...
              <div className="relative mx-auto flex h-20 w-full max-w-7xl items-center gap-6 px-4 sm:px-6 lg:px-8">
                <div className="pointer-events-none absolute inset-x-6 bottom-0 top-1/2 -z-10 rounded-3xl bg-gradient-to-b from-white via-white/92 to-white" aria-hidden />
                <Link
                  href="/"
